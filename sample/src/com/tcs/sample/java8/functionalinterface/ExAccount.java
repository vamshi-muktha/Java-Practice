...
public class ExAccount {
	public static void main(String[] args) {
		Comparator<Account> c1 = new Comparator<Account>() {
		...
		TreeSet<Account> ts1 = new TreeSet<Account>(c1);
		...
		TreeSet<Account> ts2 = new TreeSet<Account>(c2);
		...
		TreeSet<Account> ts3 = new TreeSet<Account>((a, b) -> b.getCustId().compareTo(a.getCustId()));
